 ...
 */
  ...
  __pyx_t_1 = ((PyObject *)PyGreenlet_GetCurrent()); if (unlikely(!__pyx_t_1)) __PYX_ERR(1, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
...
static int __Pyx_modinit_type_init_code(void) {
  ...
  __pyx_ptype_6gevent_19__abstract_linkable_greenlet = __Pyx_ImportType(__pyx_t_1, "greenlet", "greenlet", sizeof(PyGreenlet), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_6gevent_19__abstract_linkable_greenlet) __PYX_ERR(1, 12, __pyx_L1_error)
